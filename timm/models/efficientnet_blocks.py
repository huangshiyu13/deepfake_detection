...
class DepthwiseSeparableConv(nn.Module):
    ...
    def __init__(self, in_chs, out_chs, dw_kernel_size=3,
        ...
        # self.bn1 = nn.BatchNorm2d(in_chs, track_running_stats=True)
        self.act1 = act_layer(inplace=True)
        ...
        # self.bn2 = nn.BatchNorm2d(out_chs, track_running_stats=True)
...
class InvertedResidual(nn.Module):
    ...
    def __init__(self, in_chs, out_chs, dw_kernel_size=3,
        ...
        # self.bn1 = nn.GroupNorm(4,mid_chs)
        # self.bn1 = nn.BatchNorm2d(mid_chs, track_running_stats=False)
        ...
        # self.bn2 = nn.GroupNorm(2, mid_chs)
        self.bn2 = norm_layer(mid_chs, **norm_kwargs)
        # self.bn2 = nn.BatchNorm2d(mid_chs, track_running_stats=False)
        ...
        # self.bn3 = nn.BatchNorm2d(out_chs, track_running_stats=False)
    ...
    def forward(self, x):
        ...
        # 192,288,480,960,1344,2304,3840
        # if not x.shape[1] in [192,3840]:
        x = self.bn2(x)
        ...
        # if not x.shape[1] in [48, 80, 160, 224,384,640]:
        x = self.bn3(x)
        # 48 80 160 224 384 640
